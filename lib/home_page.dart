...
//   List<String> currencies = ['USD', 'EUR', 'GBP', 'JPY', 'AUD', 'CAD']; // Default currencies
//   bool isLoading = true;
...
//         if (data['data'] != null) {
//           setState(() {
//             currencies = (data['data'] as Map<String, dynamic>).keys.toList();
//             if (data['data'][ToCurrency] != null) {
...
//     } catch (e) {
//       print("Error: $e");
//       // If there's an error, use default currencies
//       setState(() {
//         isLoading = false;
//       });
//     }
...
//         }
//       } else {
//         print("Rate API Error: ${response.statusCode}");
//       }
//     } catch (e) {
...
//                               value: FromCurrency,
//                               isExpanded: true,
//                               dropdownColor: Color.fromARGB(255, 43, 43, 44),
